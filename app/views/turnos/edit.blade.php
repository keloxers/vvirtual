	...
	<div class="pi-section pi-padding-bottom-80">
		...
		<div class="pi-row">
			...
			<div class="pi-col-xs-8">
				...
				<!-- Forms -->
				{{ Form::open(array('url' => URL::to('/turnos/' . $turno->id), 'method' => 'PUT', 'class' => 'panel-body wrapper-lg')) }}
				...
				<div class="form-group">
					...
					<div class="pi-input-with-icon">
						...
						{{ Form::text('fecha', $turno->fecha, array('class' => 'form-control', 'id' => 'fecha', 'placeholder' => 'Fecha')) }} AAAA/MM/DD
				...
				<!-- End first name form -->
					...
					<div class="form-group">
						...
						<div class="pi-input-with-icon">
							<div class="pi-input-icon"><i class="icon-pencil"></i></div>
							{{ Form::text('turno', $turno->turno, array('class' => 'form-control', 'id' => 'turno', 'placeholder' => 'Ingrese farmacia de turno')) }}
