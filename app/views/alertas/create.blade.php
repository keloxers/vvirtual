	...
	<div class="pi-section pi-padding-bottom-80">
		...
		<div class="pi-row">
			...
			<div class="pi-col-xs-12">
				...
				<!-- Forms -->
				{{ Form::open(array('route' => 'alertas.store', 'class' => 'panel-body wrapper-lg')) }}

					<!-- First name form -->
					<div class="form-group">
						<label for="empresa">Alerta</label>

						<div class="pi-input-with-icon">
							<div class="pi-input-icon"><i class="icon-pencil"></i></div>
							{{ Form::text('alerta', '', array('class' => 'form-control', 'id' => 'alerta', 'placeholder' => 'Alerta')) }}
					...
					<div class="form-group">
						...
						<div class="pi-input-with-icon">
							<div class="pi-input-icon"><i class="icon-pencil"></i></div>
							{{ Form::text('mensaje', '', array('class' => 'form-control', 'id' => 'mensaje', 'placeholder' => 'mensaje')) }}
