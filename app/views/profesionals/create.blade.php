			...
			<!-- {{ Form::open(array('route' => 'archivos.store', 'files' => true, 'class'=>'panel-body wrapper-lg', 'enctype' => 'multipart/form-data')) }} -->
					...
					<div class="form-group">
						<label for="exampleInputMessage-3">Categoria</label>
								...
								{{ Form::select( 'profesionalscategorias_id', profesionalscategoria::All()->
										lists('profesionalscategoria', 'id'), Input::get('profesionalscategoria'), array( "placeholder" => "", 'class' => 'form-control input-lg')) }}
					...
					<div class="form-group">
						...
						<div class="pi-input-with-icon">
							...
							{{ Form::text('profesional', '', array('class' => 'form-control', 'id' => 'profesional', 'placeholder' => 'Ingrese tu profesional')) }}
...
<div class="form-group">
			...
			<input name="file" type="file"/>
						...
						<div class="form-group">
							...
							<div class="pi-input-with-icon">
								<div class="pi-input-icon"><i class="icon-pencil"></i></div>
								{{ Form::text('precio', '', array('class' => 'form-control', 'id' => 'precio', 'placeholder' => 'Precio del profesional')) }}
					...
					<p>
						<button type="submit" class="btn pi-btn-base pi-btn-big pi-uppercase pi-weight-700 pi-letter-spacing">
							<i class="icon-check pi-icon-left"></i>Enviar profesional
						</button>
					</p>
					<!-- End submit button -->
